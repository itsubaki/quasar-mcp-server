...
func NewOpenQASM3p0Run(identityToken, targetURL string) (*mcp.Tool, mcp.ToolHandlerFor[*OpenQASM3p0RunInput, *OpenQASM3p0RunOutput]) {
	return &mcp.Tool{
		Name:        "openqasm3p0_run",
		Description: "run a quantum circuit using OpenQASM 3.0",
	}, OpenQASM3p0RunHandler(identityToken, targetURL)
}
...
func OpenQASM3p0RunHandler(identityToken, targetURL string) mcp.ToolHandlerFor[*OpenQASM3p0RunInput, *OpenQASM3p0RunOutput] {
	return func(
		ctx context.Context,
